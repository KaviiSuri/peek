...
const model = {
  ...
  tabs: [{ id: 1, windowId: 2, title: "Atlas", url: "https://example.test/atlas", lastAccessed: 3, current: false }],
};
...
describe("overlay protocol decoding", () => {
  it("accepts valid init, model and dismiss messages", () => {
    ...
    expect(decodeModelMessage({ kind: "peek/model", sessionId: "s", model })).toBeDefined();
