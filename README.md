...
This is not the complete v0. Peek includes forgiving title/URL clue matching and a Tab-toggled keyboard selection mode; the restricted-page fallback belongs to a later ticket.
