...
6. Open `chrome://settings/` or another known restricted Chrome surface. Invocation opens the same palette in a centred transient browser window. Chrome Web Store pages are also explicitly classified because Chrome blocks extension injection there despite their HTTPS scheme.
