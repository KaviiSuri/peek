...
`npm run build` writes the unpacked MV3 extension to `dist/`. The build contains `manifest.json`, the background and shared palette bundles, and the static fallback extension page. The extension has no remote code or runtime assets.
